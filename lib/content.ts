...
export const features: Feature[] = [
  {
    ...
    description:
      "AI-powered dynamic pricing with real-time market analysis, demand forecasting, and competitive intelligence.",
  ...
  },
  {
    title: "POS System",
    description:
      "Complete point-of-sale solutions with payment processing, customer management, and analytics.",
  ...
  },
  {
    ...
    description:
      "Automated inventory tracking with predictive analytics and supply chain optimization.",
  ...
  },
  {
    ...
    description:
      "Complete retail transformation from front-end customer experience to back-end operations management.",
