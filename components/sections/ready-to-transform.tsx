                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="text-[16px] leading-7 tracking-[0.01em] text-[#B4BEBC]">
                                We deliver comprehensive systems that seamlessly integrate pricing, inventory, and point-of-sale operations to create a unified
                                retail ecosystem that drives efficiency and growth.
                            </p>
                        </div>
