            ...
            <div className="flex flex-1 items-center justify-center px-4 sm:px-8 lg:px-12">
                <MaxWidthWrapper className="flex flex-col items-center gap-16 pb-24 pt-24">
                    ...
                    <div className="flex flex-wrap items-start justify-center gap-5">
                        <Button className="primary-cta gap-2 h-12 min-w-[164px] rounded-lg px-6 text-base font-semibold shadow-button" asChild>
                            <a href="#contact">
                                Get Started
                                <ArrowUpRight className="h-4 w-4" />
                            </a>
                        </Button>
                        <Button variant="outline" className="glassy-outline h-12 min-w-[134px] rounded-lg bg-white/80 px-6 text-base font-semibold" asChild>
                        ...
                        {[
                            ...
                            >
                                <div className="hero-gallery-frame">
                                    <Image src={image.src} alt={image.alt} className="h-full w-full rounded-2xl object-cover" loading="lazy" />
                                </div>
                            </div>
                        ))}
                    </div>
