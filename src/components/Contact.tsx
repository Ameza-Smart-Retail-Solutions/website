        ...
        <section id="contact" className="py-20 bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-700">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-emerald-100 max-w-3xl mx-auto">Ready to transform your grocery business? Get in touch today.</p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center">
                        ...
                        <p className="text-emerald-100 mb-6">Complete retail transformation for businesses of any size, from small shops to large chains.</p>
                        <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors">Get Demo</button>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center">
                        ...
                        <p className="text-emerald-100 mb-6">Real-time stock tracking and automated reordering to prevent stockouts and reduce waste.</p>
                        <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors">Learn More</button>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center">
                        ...
                        <p className="text-emerald-100 mb-6">AI-powered price optimization based on demand, competition, and inventory levels.</p>
